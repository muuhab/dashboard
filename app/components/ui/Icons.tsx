...
export const Icons = {
    ...
    phone: (props: any) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16" {...props}>
            <path fill="#2E2C34" d="M11.333.673 4.666.667c-.733 0-1.333.6-1.333 1.333v12c0 .733.6 1.333 1.333 1.333h6.667c.733 0 1.333-.6 1.333-1.333V2c0-.734-.6-1.327-1.333-1.327Zm0 11.993H4.666V3.333h6.667v9.333Z" />
        </svg>

    ),
    instagram: (props: any) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="none" viewBox="0 0 13 13" {...props}>
            <path fill="#2E2C34" fill-rule="evenodd" d="M12.596 3.713c-.048-1.012-.28-1.909-1.021-2.648-.739-.739-1.636-.97-2.648-1.02-1.043-.06-4.17-.06-5.214 0-1.01.047-1.906.279-2.648 1.017-.741.74-.97 1.636-1.02 2.648-.06 1.044-.06 4.17 0 5.214.047 1.013.279 1.91 1.02 2.648.742.739 1.636.97 2.648 1.021 1.043.06 4.17.06 5.214 0 1.012-.048 1.91-.28 2.648-1.02.739-.74.97-1.636 1.02-2.649.06-1.043.06-4.168 0-5.21Zm-2.902-.011a.756.756 0 1 0 0-1.511.756.756 0 0 0 0 1.51Zm-3.373-.623a3.235 3.235 0 0 0-3.24 3.24 3.235 3.235 0 0 0 3.24 3.24 3.235 3.235 0 0 0 3.24-3.24 3.235 3.235 0 0 0-3.24-3.24Zm0 5.346A2.11 2.11 0 0 1 4.216 6.32a2.11 2.11 0 0 1 2.107-2.107c1.161 0 2.106.945 2.106 2.107a2.11 2.11 0 0 1-2.106 2.106Zm3.726 2.82a2.133 2.133 0 0 0 1.2-1.201c.284-.711.268-2.267.258-3.275l-.003-.45.003-.45c.01-1.008.026-2.562-.257-3.275a2.132 2.132 0 0 0-1.201-1.202c-.714-.281-2.277-.266-3.285-.257l-.44.003-.45-.003c-1.008-.01-2.562-.026-3.276.257a2.133 2.133 0 0 0-1.2 1.202c-.282.713-.267 2.276-.258 3.284l.003.44-.003.45c-.01 1.009-.026 2.562.257 3.276.223.555.649.981 1.201 1.201.714.282 2.277.267 3.285.257a47.437 47.437 0 0 1 .89 0c1.008.01 2.562.026 3.276-.257Z" clip-rule="evenodd" />
        </svg>

    ),
    call: (props: any) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" {...props}>
            <path d="M13.34 10.2533C12.52 10.2533 11.7267 10.12 10.9867 9.88C10.7533 9.8 10.4933 9.86 10.3133 10.04L9.26667 11.3533C7.38 10.4533 5.61333 8.75333 4.67333 6.8L5.97333 5.69333C6.15333 5.50667 6.20667 5.24667 6.13333 5.01333C5.88667 4.27333 5.76 3.48 5.76 2.66C5.76 2.3 5.46 2 5.1 2H2.79333C2.43333 2 2 2.16 2 2.66C2 8.85333 7.15333 14 13.34 14C13.8133 14 14 13.58 14 13.2133V10.9133C14 10.5533 13.7 10.2533 13.34 10.2533Z" fill="#504F54" />
        </svg>
    ),
    account: (props: any) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" {...props}>
            <path d="M9 2.49756C4.86 2.49756 1.5 5.85756 1.5 9.99756C1.5 14.1376 4.86 17.4976 9 17.4976C13.14 17.4976 16.5 14.1376 16.5 9.99756C16.5 5.85756 13.14 2.49756 9 2.49756ZM9 4.74756C10.245 4.74756 11.25 5.75256 11.25 6.99756C11.25 8.24256 10.245 9.24756 9 9.24756C7.755 9.24756 6.75 8.24256 6.75 6.99756C6.75 5.75256 7.755 4.74756 9 4.74756ZM9 15.3976C7.125 15.3976 5.4675 14.4376 4.5 12.9826C4.5225 11.4901 7.5 10.6726 9 10.6726C10.4925 10.6726 13.4775 11.4901 13.5 12.9826C12.5325 14.4376 10.875 15.3976 9 15.3976Z" fill="#B6B4BA" />
        </svg>
    ),
    autoRenew: (props: any) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" {...props}>
            <path d="M8.00033 3.99984V5.99984L10.667 3.33317L8.00033 0.666504V2.6665C5.05366 2.6665 2.66699 5.05317 2.66699 7.99984C2.66699 9.0465 2.97366 10.0198 3.49366 10.8398L4.46699 9.8665C4.16699 9.31317 4.00033 8.67317 4.00033 7.99984C4.00033 5.79317 5.79366 3.99984 8.00033 3.99984ZM12.507 5.15984L11.5337 6.13317C11.827 6.69317 12.0003 7.3265 12.0003 7.99984C12.0003 10.2065 10.207 11.9998 8.00033 11.9998V9.99984L5.33366 12.6665L8.00033 15.3332V13.3332C10.947 13.3332 13.3337 10.9465 13.3337 7.99984C13.3337 6.95317 13.027 5.97984 12.507 5.15984V5.15984Z" fill="#5542F6" />
        </svg>
    )
