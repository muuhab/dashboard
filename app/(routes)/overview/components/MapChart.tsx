...
import topology from '@/app/data/us-topo.json';
import stateAbbrs from '@/app/data/us-abbr.json';
import configs from '@/app/config/settings';
...
export const colors: string[] = [configs.colors.purpleMain, configs.colors.dark4];
...
export default function GeoAlbersUsa({ width, height, ...props }: GeoAlbersUsaProps & React.SVGProps<SVGSVGElement>) {
    ...
    return width < 10 ? null : (
        <>
            <svg width={width} height={height} style={{ borderRadius: '14px' }} {...props}>
